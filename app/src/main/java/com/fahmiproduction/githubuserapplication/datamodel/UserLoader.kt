...
import com.fahmiproduction.githubuserapplication.adapter.ListAdapter
import com.fahmiproduction.githubuserapplication.ui.DetailActivity
...
class UserLoader {
    fun setUserListData(
        ...
        if (listUser.isEmpty()) {
            ...
            rvUser.adapter = ListAdapter(listUser).apply {
